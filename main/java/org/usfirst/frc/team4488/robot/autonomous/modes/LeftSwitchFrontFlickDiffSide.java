...
public class LeftSwitchFrontFlickDiffSide extends AutoModeBase {

  @Override
  protected void routine() throws AutoModeEndedException {
    PathContainer mPath = new LeftSwitchFrontFlickDiffSidePath();
    ...
    waitAndFlick.add(new TimerWait(275));
