...
import org.usfirst.frc.team4488.robot.app.paths.untested_paths.LeftSideSameScaleStayOutOfWay;
import org.usfirst.frc.team4488.robot.app.paths.untested_paths.LeftSideSameScaleStayOutOfWayBackUp;
...
public class LeftCrossLineOwnScaleSameSideBackUp extends AutoModeBase {
  @Override
  protected void routine() throws AutoModeEndedException {

    PathContainer mPath = new LeftSideSameScaleStayOutOfWay();
    ...
    runAction(auto);
    runAction(new DrivePathAction(new LeftSideSameScaleStayOutOfWayBackUp()));
