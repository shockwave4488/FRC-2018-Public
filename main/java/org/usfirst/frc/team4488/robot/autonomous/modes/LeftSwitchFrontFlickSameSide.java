...
public class LeftSwitchFrontFlickSameSide extends AutoModeBase {

  @Override
  protected void routine() throws AutoModeEndedException {
    PathContainer mPath = new LeftSwitchFrontFlickSameSidePath();
    ...
    waitAndFlick.add(new TimerWait(650));
