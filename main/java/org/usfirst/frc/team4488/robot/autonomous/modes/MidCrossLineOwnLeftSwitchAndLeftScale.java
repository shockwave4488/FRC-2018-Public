...
import org.usfirst.frc.team4488.robot.app.paths.MidCrossLineOwnLeftSwitchAndLeftScalePart1;
import org.usfirst.frc.team4488.robot.app.paths.MidCrossLineOwnLeftSwitchAndLeftScalePart2;
...
import org.usfirst.frc.team4488.robot.app.paths.MidCrossLineOwnLeftSwitchAndLeftScalePart5;
...
public class MidCrossLineOwnLeftSwitchAndLeftScale extends AutoModeBase {
  @Override
  protected void routine() throws AutoModeEndedException {
    // TODO run and tune this
    PathContainer mPath = new MidCrossLineOwnLeftSwitchAndLeftScalePart1();
    ...
    parallel.add(new DrivePathAction(new MidCrossLineOwnLeftSwitchAndLeftScalePart2()));
    ...
    driveAndMoveLift.add(new DrivePathAction(new MidCrossLineOwnLeftSwitchAndLeftScalePart5()));
