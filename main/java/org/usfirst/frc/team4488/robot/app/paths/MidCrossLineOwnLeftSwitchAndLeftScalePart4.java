...
public class MidCrossLineOwnLeftSwitchAndLeftScalePart4 implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(80, 150, 0, 0));
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(80, 150), Rotation2d.fromDegrees(0.0));
  }
  ...
  // WAYPOINT_DATA:[{"position":{"x":80,"y":150},"speed":0,"radius":0,"comment":""},{"position":{"x":40,"y":155},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: true
  // FILE_NAME: MidCrossLineOwnLeftSwitchAndLeftScalePart4
}
