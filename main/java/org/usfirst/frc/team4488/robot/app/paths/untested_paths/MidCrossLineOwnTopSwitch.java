...
public class MidCrossLineOwnTopSwitch implements PathContainer {
  ...
  public Path buildPath() {
    ...
    sWaypoints.add(new Waypoint(130, 262, 20, 60));
    sWaypoints.add(new Waypoint(170, 262, 0, 60));
  ...
  // WAYPOINT_DATA:
  // [{"position":{"x":15,"y":160},"speed":60,"radius":0,"comment":""},{"position":{"x":35,"y":160},"speed":60,"radius":10,"comment":""},{"position":{"x":130,"y":262},"speed":60,"radius":20,"comment":""},{"position":{"x":170,"y":262},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: false
