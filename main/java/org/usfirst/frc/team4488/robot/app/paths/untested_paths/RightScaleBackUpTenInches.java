...
public class RightScaleBackUpTenInches implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(280, 82, 0, 0));
    sWaypoints.add(new Waypoint(268, 62, 0, 60));
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(280, 82), Rotation2d.fromDegrees(0.0));
  }
  ...
  // WAYPOINT_DATA:[{"position":{"x":280,"y":82},"speed":0,"radius":0,"comment":""},{"position":{"x":268,"y":62},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: true
  // FILE_NAME: RightScaleBackUpTenInches
}
