...
public class P1RightCrossLineOwnSwitchTwice implements PathContainer {
  ...
  // WAYPOINT_DATA:
  // [{"position":{"x":15,"y":60},"speed":0,"radius":0,"comment":""},{"position":{"x":170,"y":60},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: P1RightCrossLineOwnScaleTwice
}
