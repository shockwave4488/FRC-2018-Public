...
public class PivotTestTwo implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(110, 50, 0, 0));
    sWaypoints.add(new Waypoint(50, 50, 0, 20));
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(110, 50), Rotation2d.fromDegrees(0.0));
  }
  ...
  // WAYPOINT_DATA:[{"position":{"x":110,"y":50},"speed":0,"radius":0,"comment":""},{"position":{"x":50,"y":50},"speed":20,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: PivotTestTwo
}
