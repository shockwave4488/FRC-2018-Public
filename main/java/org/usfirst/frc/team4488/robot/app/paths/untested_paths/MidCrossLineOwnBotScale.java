...
public class MidCrossLineOwnBotScale implements PathContainer {
  ...
  public Path buildPath() {
    ...
    sWaypoints.add(new Waypoint(140, 50, 30, 60));
  ...
  // WAYPOINT_DATA:
  // [{"position":{"x":15,"y":160},"speed":60,"radius":0,"comment":""},{"position":{"x":35,"y":160},"speed":60,"radius":10,"comment":""},{"position":{"x":140,"y":50},"speed":60,"radius":30,"comment":""},{"position":{"x":330,"y":50},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: false
