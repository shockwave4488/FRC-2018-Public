...
public class RightSideCrossLineStopEarlyPath implements PathContainer {
  ...
  // WAYPOINT_DATA:[{"position":{"x":15,"y":45},"speed":0,"radius":0,"comment":""},{"position":{"x":235,"y":45},"speed":60,"radius":60,"comment":""},{"position":{"x":235,"y":160},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: RightSideCrossLineStopEarlyPath
}
