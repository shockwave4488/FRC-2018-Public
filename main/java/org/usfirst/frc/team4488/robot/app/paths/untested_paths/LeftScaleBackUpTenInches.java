...
public class LeftScaleBackUpTenInches implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(280, 245, 0, 0));
    sWaypoints.add(new Waypoint(268, 265, 0, 60));
  ...
  // WAYPOINT_DATA:[{"position":{"x":280,"y":245},"speed":0,"radius":0,"comment":""},{"position":{"x":268,"y":265},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: true
  // FILE_NAME: LeftScaleBackUpTenInches
}
