...
public class PivotTestOne implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(50, 50, 0, 0));
    sWaypoints.add(new Waypoint(110, 50, 0, 20));
  ...
  // WAYPOINT_DATA:[{"position":{"x":50,"y":50},"speed":0,"radius":0,"comment":""},{"position":{"x":110,"y":50},"speed":20,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: PivotTestOne
}
