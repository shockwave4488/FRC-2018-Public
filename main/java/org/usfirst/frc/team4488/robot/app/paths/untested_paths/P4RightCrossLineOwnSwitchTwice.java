...
public class P4RightCrossLineOwnSwitchTwice implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(215, 80, 0, 0));
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(215, 80), Rotation2d.fromDegrees(180.0));
  }
  ...
  // WAYPOINT_DATA:
  // [{"position":{"x":215,"y":80},"speed":0,"radius":0,"comment":""},{"position":{"x":240,"y":50},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: true
  // FILE_NAME: P4RightCrossLineOwnSwitchTwice
}
