...
public class LeftTurnTest implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(0, 0, 0, 0));
    sWaypoints.add(new Waypoint(60, 0, 50, 60));
  ...
  // WAYPOINT_DATA:[{"position":{"x":0,"y":0},"speed":0,"radius":0,"comment":""},{"position":{"x":60,"y":0},"speed":60,"radius":50,"comment":""},{"position":{"x":60,"y":60},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: LeftTurnTest
}
