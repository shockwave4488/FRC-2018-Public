...
public class RightSideSameScaleSecondCubeSwitchPartThree implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(215, 92, 0, 0));
    sWaypoints.add(new Waypoint(210, 92, 0, 60));
  ...
  // WAYPOINT_DATA:[{"position":{"x":215,"y":92},"speed":0,"radius":0,"comment":""},{"position":{"x":210,"y":92},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: RightSideSameScaleSecondCubeSwitchPartThree
}
