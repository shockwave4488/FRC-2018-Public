...
public class DriveFiveInchesRight implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(255, 80, 0, 0));
    sWaypoints.add(new Waypoint(280, 90, 0, 20));
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(255, 80), Rotation2d.fromDegrees(0.0));
  }
  ...
  // WAYPOINT_DATA:[{"position":{"x":255,"y":80},"speed":0,"radius":0,"comment":""},{"position":{"x":280,"y":90},"speed":20,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: DriveFiveInchesRight
}
