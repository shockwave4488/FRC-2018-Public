...
public class RightSideSameScaleSecondCubePartThreeTest implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(225, 90, 0, 0));
    sWaypoints.add(new Waypoint(290, 85, 0, 60));
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(225, 90), Rotation2d.fromDegrees(0.0));
  }
  ...
  // WAYPOINT_DATA:[{"position":{"x":225,"y":90},"speed":0,"radius":0,"comment":""},{"position":{"x":290,"y":85},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: RightSideSameScaleSecondCubePartThreeTest
}
