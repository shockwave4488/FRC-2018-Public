...
public class MidCrossLineOwnLeftSwitchAndLeftScalePart5 implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(40, 155, 0, 0));
    sWaypoints.add(new Waypoint(90, 155, 40, 90));
    sWaypoints.add(new Waypoint(90, 265, 30, 90));
    sWaypoints.add(new Waypoint(140, 265, 0, 90));
  ...
  // WAYPOINT_DATA:[{"position":{"x":40,"y":155},"speed":0,"radius":0,"comment":""},{"position":{"x":90,"y":155},"speed":90,"radius":40,"comment":""},{"position":{"x":90,"y":265},"speed":90,"radius":30,"comment":""},{"position":{"x":140,"y":265},"speed":90,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: MidCrossLineOwnLeftSwitchAndLeftScalePart5
}
