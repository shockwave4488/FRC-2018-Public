...
public class MidCrossLineOwnRightSwitchAndRightScalePart2 implements PathContainer {
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(115, 105), Rotation2d.fromDegrees(0.0));
  }
  ...
  // WAYPOINT_DATA:[{"position":{"x":115,"y":105},"speed":0,"radius":0,"comment":""},{"position":{"x":90,"y":105},"speed":60,"radius":15,"comment":""},{"position":{"x":50,"y":155},"speed":40,"radius":10,"comment":""},{"position":{"x":30,"y":155},"speed":30,"radius":0,"comment":""}]
  // IS_REVERSED: true
  // FILE_NAME: MidCrossLineOwnRightSwitchAndRightScalePart2
}
