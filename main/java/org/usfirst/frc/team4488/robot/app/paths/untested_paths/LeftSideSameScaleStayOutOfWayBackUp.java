...
public class LeftSideSameScaleStayOutOfWayBackUp implements PathContainer {

  @Override
  public Path buildPath() {
    ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
    sWaypoints.add(new Waypoint(320, 264, 0, 0));
  ...
  public RigidTransform2d getStartPose() {
    return new RigidTransform2d(new Translation2d(320, 264), Rotation2d.fromDegrees(0.0));
  }
  ...
  // WAYPOINT_DATA:[{"position":{"x":320,"y":264},"speed":0,"radius":0,"comment":""},{"position":{"x":320,"y":300},"speed":60,"radius":0,"comment":""}]
  // IS_REVERSED: true
  // FILE_NAME: LeftSideSameScaleStayOutOfWayBackUp
}
