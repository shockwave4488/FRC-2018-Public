...
public class MidCrossLineOwnLeftSwitchAndLeftScalePart1 implements PathContainer {
  ...
  public Path buildPath() {
    ...
    sWaypoints.add(new Waypoint(90, 220, 20, 60, "LiftUp"));
    sWaypoints.add(new Waypoint(115, 220, 0, 40));
  ...
  // WAYPOINT_DATA:[{"position":{"x":15,"y":155},"speed":0,"radius":0,"comment":""},{"position":{"x":50,"y":155},"speed":60,"radius":30,"comment":""},{"position":{"x":90,"y":220},"speed":60,"radius":20,"comment":""},{"position":{"x":115,"y":220},"speed":40,"radius":0,"comment":""}]
  // IS_REVERSED: false
  // FILE_NAME: MidCrossLineOwnLeftSwitchAndLeftScalePart1
}
